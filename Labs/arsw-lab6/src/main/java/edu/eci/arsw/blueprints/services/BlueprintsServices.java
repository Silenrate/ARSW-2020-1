...
public class BlueprintsServices {
    ...
    /**
     * Metodo encargado de eliminar un plano
     *
     * @param authorName    blueprint's author
     * @param blueprintName blueprint's name
     * @throws BlueprintNotFoundException if there is no such blueprint
     */
    public void deleteBlueprint(String authorName, String blueprintName) throws BlueprintNotFoundException {
        bpp.deleteBlueprint(authorName, blueprintName);
    }
}
